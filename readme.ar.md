...
<div dir="rtl"><em>(نرى: <a href="#HOW_TO_USE_PDO">ما هو "PDO DSN"؟ كيف يمكنني استخدام PDO مع CIDRAM؟</a>)</em><br /><br /></div>
...
mysql:dbname=cidram;host=localhost;port=3306
 ...
 └─mysql:dbname=cidram;host=localhost;port=3306
   ╚╤══╝        ╚╤═══╝      ╚╤══════╝      ╚╤═╝
    ...
    │
    └اسم برنامج تشغيل قاعدة البيانات لاستخدام
```
...
<div dir="rtl">آخر تحديث: 20 اكتوبر 2019 (2019.10.20).</div>
