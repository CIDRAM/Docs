...
├─CAPTCHAs-Failed ("محاولات CAPTCHA – فشل (%s)!")
├─CAPTCHAs-Passed ("محاولات CAPTCHA – نجحت (%s)!")
...
* هذا الخيار له تجاوز مناظر تحت <code dir="ltr" class="s">used⬅bypasses</code>. يوصى بالتأكد من وضع علامة على خانة الاختيار الخاصة بالتجاوز المقابل بنفس طريقة مربع الاختيار لمحاولة التحقق من هذا الخيار.
...
##### <div dir="rtl">٦.٢.١ كيفية "تحمل علامة" أقسام توقيع للاستخدام مع hCaptcha<br /><br /></div>

<div dir="rtl">عندما "usemode" هو 2 أو 5، من أجل دلالة أقسام توقيع للاستخدام مع اختبار hCaptcha، تشير إلى أن في YAML لهذا القسم التوقيع (راجع الأمثلة أدناه).<br /><br /></div>
...
<div dir="rtl">آخر تحديث: ٢١ أغسطس ٢٠٢٥ (٢٠٢٥.٠٨.٢١).</div>
