...
3. Перейдите на страницу резервного копирования фронтенда. Выберите экспорт, отметьте галочками поля конфигурации и вспомогательных правил и нажмите «ОК» чтобы загрузить резервную копию текущей конфигурации и вспомогательных правил. В доступную конфигурацию и систему вспомогательных правил были внесены некоторые изменения. Например, действие «не регистрировать» было удалено из вспомогательных правил (вместо него можно использовать опцию «подавить ведение журнала» для достижения того же результата). После обновления вам потребуется импортировать эту резервную копию обратно в CIDRAM, чтобы CIDRAM мог при необходимости скорректировать ваши вспомогательные правила и конфигурацию для учета этих изменений.
...
7. Вернитесь на страницу резервного копирования фронтенда. Выберите импорт, отметьте галочками поля конфигурации и вспомогательных правил, нажмите кнопку чтобы выбрать файл, найдите и выберите ранее загруженную резервную копию, и нажмите «ОК» чтобы импортировать эту резервную копию. CIDRAM автоматически скорректирует любые вспомогательные правила и конфигурацию в резервных копиях предыдущих основных версий по мере необходимости чтобы соответствовать импортируемой основной версии.
...
Последнее обновление: 5 Октября 2025 г (2025.10.05).
