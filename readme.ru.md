...
##### «config_imports»
- Список файлов, разделенных запятыми, для импорта в стандартную конфигурацию CIDRAM. Обычно заполняется по мере необходимости на странице обновлений при активации компонентов. По стандарту пустой. В большинстве случаев можно игнорировать это.
...
Последнее обновление: 1 Июля 2021 г (2021.07.01).
