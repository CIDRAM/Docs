...
- [Я хочу использовать CIDRAM v3~v4 с версией PHP ниже 7.2; Вы можете помочь?](#user-content-MINIMUM_PHP_VERSION_V3)
...
#### <a name="MINIMUM_PHP_VERSION_V3"></a>Я хочу использовать CIDRAM v3~v4 с версией PHP ниже 7.2; Вы можете помочь?

Нет. PHP≥7.2 является минимальным требованием для CIDRAM v3~v4.
...
Последнее обновление: 14 Февраля 2026 г (2026.02.14).
