...
__FAQ.__ <em><a href="https://github.com/CIDRAM/Docs/blob/master/readme.ru.md#что-я-могу-использовать-для-default_dns" hreflang="ru">Что я могу использовать для «default_dns»?</a></em>
...
__FAQ.__ <em><a href="https://github.com/CIDRAM/Docs/blob/master/readme.ru.md#user-content-HOW_TO_USE_PDO" hreflang="ru">Что такое «PDO DSN»? Как я могу использовать PDO с CIDRAM?</a></em>
...
Последнее обновление: 25 Марта 2023 г (2023.03.25).
