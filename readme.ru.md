...
В контексте CIDRAM термин «CIDR» (или «CIDRы») относится конкретно к подсетям, выраженным с использованием нотации CIDR.
...
Последнее обновление: 1 Апреля 2026 г (2026.04.01).
