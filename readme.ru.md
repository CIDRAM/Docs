...
** Требуется функция поиска ASN (например, через модуль IP-API или BGPView).
...
__FAQ.__ <em><a href="https://github.com/CIDRAM/Docs/blob/master/readme.ru.md#что-я-могу-использовать-для-default_dns" hreflang="ru-RU">Что я могу использовать для «default_dns»?</a></em>
...
* Эта опция имеет соответствующий байпас под <code class="s">bypasses➡used</code>. Рекомендуется убедиться, что флажок для соответствующего байпаса отмечен так же, как флажок для попытки проверки этой опции.
...
__FAQ.__ <em><a href="https://github.com/CIDRAM/Docs/blob/master/readme.ru.md#user-content-HOW_TO_USE_PDO" hreflang="ru-RU">Что такое «PDO DSN»? Как я могу использовать PDO с CIDRAM?</a></em>
...
Последнее обновление: 14 Июня 2023 г (2023.06.14).
