...
5. Nu de core en de front-end zijn bijgewerkt en de paginastructuur en CSS-opmaak correct worden weergegeven, u kan de rest bijwerken. Ga terug naar de front-end updates pagina en, als u de knop bovenaan de pagina ziet, klik op bijwerken alles.
