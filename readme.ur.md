...
<div dir="rtl"><ul><li>"http_response_header_code" کی جگہ لے لے، جب "infraction_limit" حد سے تجاوز کر رہا ہے؟ 200 = جگہ لے لے نہیں ہے [پہلے سے طے شدہ]. دیگر اقدار "http_response_header_code" کے لیے دستیاب اقدار کے طور پر اسی ہیں.</li></ul></div>
...
<div dir="rtl"><ul><li>بیرونی درخواستوں کے لیے استعمال کرنے کیکے لیے پہلے سے طے شدہ ٹائم آؤٹ؟ پہلے سے طے شدہ = 12 سیکنڈ.</li></ul></div>
...
<div dir="rtl">شرح کو محدود کرنے کی ترتیبات (عام استعمال کے لیے سفارش نہیں کی جاتی ہے).<br /><br /></div>
