...
File | Description
----|----
/tests/ | A directory containing various files used for CI (continuous integration) testing.
...
/vault/channels.yaml | Alternative channels data for failed curl requests.
