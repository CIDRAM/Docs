...
7. 先ほどダウンロードしたバックアップをインポートするには、フロントエンド・バックアップ・ページで、「インポートして」を選択し、コンフィギュレーションと補助ルールのボックスにチェックを入れ、ファイル選択ボタンをクリックして、バックアップ・ファイルを見つけて選択し、「ＯＫ」を押します。​CIDRAMは、新しいメジャー・バージョンに対応するために必要に応じて、以前のメジャー・バージョンからのバックアップ内の補助ルールとコンフィギュレーションを自動的に調整します。
