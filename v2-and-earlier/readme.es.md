...
- 5. [ARCHIVOS INCLUIDOS EN ESTE PAQUETE](#user-content-SECTION5)
- 6. [OPCIONES DE CONFIGURACIÓN](#user-content-SECTION6)
- 7. [FORMATO DE FIRMAS](#user-content-SECTION7)
- 8. [CONOCIDOS PROBLEMAS DE COMPATIBILIDAD](#user-content-SECTION8)
- 9. [PREGUNTAS MÁS FRECUENTES (FAQ)](#user-content-SECTION9)
- 10. *Reservado para adiciones futuras a la documentación.*
- 11. [INFORMACIÓN LEGAL](#user-content-SECTION11)
...
*Ver también: [¿Qué puedo usar para "default_dns"?](#qué-puedo-usar-para-default_dns)*
...
- *Opciones disponibles: `GitHub,BitBucket,Codeberg,GoogleDNS`*
...
*Para obtener más información acerca de los requisitos legales y cómo esto podría afectar sus requisitos de configuración, consulte la sección "[INFORMACIÓN LEGAL](#user-content-SECTION11)" de la documentación.*
...
*Ver también: [¿Qué es un "PDO DSN"? Cómo puedo usar PDO con CIDRAM?](#user-content-HOW_TO_USE_PDO)*
...
- [Quiero usar CIDRAM (antes de v2) con una versión de PHP más vieja que 5.4.0; ¿Puede usted ayudar?](#user-content-MINIMUM_PHP_VERSION)
- [Quiero usar CIDRAM (v2) con una versión de PHP más vieja que 7.2.0; ¿Puede usted ayudar?](#user-content-MINIMUM_PHP_VERSION_V2)
...
Última Actualización: 14 de Junio de 2025 (2025.06.14).
